                    ...
                    <form class="grid gap-6 mb-6 grid-cols-1 md:grid-cols-2" action="{{route('products.update', ['product' => $product->id])}}" method="POST">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                ...
                                <input type="text" id="name" name="name" required value="{{ $product->name }}" class="min-w-[300px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-200 focus:border-red-200 block p-2.5 dark:bg-red-700 dark:border-red-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 w-full" placeholder="Nome do produto" >
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                ...
                                <input type="text" id="price" value="R$ {{ number_format($product->price, 2, ',', '.') }}" required name="price" class="min-w-[300px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-200 focus:border-red-200 block p-2.5 dark:bg-red-700 dark:border-red-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 w-full" placeholder="Preço do produto">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                ...
                                <input type="date" id="expiration_date" name="expiration_date" value="{{ $product->expiration_date }}" required class="min-w-[300px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-200 focus:border-red-200 block p-2.5 dark:bg-red-700 dark:border-red-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 w-full" >
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
                                ...
                                <input type="number" id="quantity" name="quantity" value="{{ $product->quantity }}" required class="min-w-[300px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-200 focus:border-red-200 block p-2.5 dark:bg-red-700 dark:border-red-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 w-full" placeholder="Quantidade do produto" >
                            </div>
                        </div>
                        <div class="flex items-center space-x-4">
                            <div class="flex-1">
