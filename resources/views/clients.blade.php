    ...
    <table class="min-w-full table-auto bg-white border border-red-400">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td class="px-4 py-2 border-b hover:bg-red-100">{{$client->email}}</td>
                <td class="px-4 py-2 border-b hover:bg-red-100">{{$client->phone}}</td>
                <td class="px-4 py-2 border-b hover:bg-red-100">{{$client->cpf}}</td>
                <td class="px-4 py-2 border-b hover:bg-red-100">{{ $client->address}}</td>
                ...
                <td class="px-4 py-2 border-b">
                    <div class="flex space-x-2">
                        <form action="{{route('clients.destroy', ['client' => $client->id])}}" method="post">
                            ...
                            <button type="submit" class="px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 transition duration-200">
                                Excluir
                            </button>
                        </form>
